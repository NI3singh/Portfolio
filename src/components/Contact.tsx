    ...
    <section id="contact" className="bg-transparent py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                {contactDetails.map((item, index) => (
                  <a
                    ...
                    className="flex items-center p-6 bg-surface/60 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 group border border-glass/10 hover:border-secondary/30"
                  >
              ...
              {/* Social Links */}
              <div className="bg-surface/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-glass/10">
                ...
                <div className="flex justify-center space-x-3">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`flex items-center justify-center w-12 h-12 rounded-xl bg-glass/5 border border-glass/10 text-text-primary ${social.color} transition-all duration-300 transform hover:scale-110`}
                    >
                      {social.icon}
                    </a>
                  ))}
            ...
            <div className="bg-surface/60 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-glass/10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-center mb-6">
                  ...
                  <p className="text-text-secondary">I'd love to hear about your project</p>
                </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className="w-full pl-10 pr-4 py-3 border border-glass/10 rounded-lg focus:ring-2 focus:ring-secondary/40 focus:border-transparent transition-all duration-300 bg-glass/5 focus:bg-glass/10 placeholder-text-secondary text-text-primary"
                        />
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-300 bg-glass/5 focus:bg-glass/10 placeholder-text-secondary text-text-primary ${
                            ...
                            'border-glass/10 focus:ring-secondary/40'
                          }`}
                        />
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 border border-glass/10 rounded-lg focus:ring-2 focus:ring-secondary/40 focus:border-transparent transition-all duration-300 bg-glass/5 focus:bg-glass/10 placeholder-text-secondary text-text-primary"
                      />
                    </div>

                    <div className="relative">
                      <MessageSquare className="absolute left-3 top-4 h-5 w-5 text-text-secondary" />
                      <textarea
                        name="message"
                        ...
                        rows={5}
                        required
                        className="w-full pl-10 pr-4 py-3 border border-glass/10 rounded-lg focus:ring-2 focus:ring-secondary/40 focus:border-transparent transition-all duration-300 bg-glass/5 focus:bg-glass/10 placeholder-text-secondary text-text-primary resize-none"
                      />
                    </div>
                    ...
                    <button
                      ...
                      className={`relative group w-full inline-flex items-center justify-center px-8 py-4 text-lg font-semibold transition-all duration-300 rounded-xl transform ${
                        isFormValid && !isSubmitting
                          ? 'bg-gradient-to-r from-secondary to-accent text-on-secondary hover:from-accent hover:to-secondary hover:scale-105 hover:shadow-xl'
        ...
        <div className="text-center mt-16">
          <div className="inline-block bg-surface/60 backdrop-blur-sm rounded-2xl px-8 py-4 shadow-lg border border-glass/10">
