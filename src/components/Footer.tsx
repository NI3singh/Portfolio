...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative z-10 bg-transparent border-t border-glass/10 py-8">
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-5">
          ...
          <a href="#home" onClick={(e) => { e.preventDefault(); scrollToTop(); }} className="flex items-center gap-2 group">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-r from-secondary to-accent flex items-center justify-center">
              <Code className="h-4 w-4 text-on-secondary" />
            </div>
        ...
        {/* Bottom line */}
        <div className="max-w-5xl mx-auto mt-6 pt-5 border-t border-glass/5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-text-secondary">
